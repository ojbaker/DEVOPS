...
This is a standalone FastAPI implementation for the Nurse Mate backend,
including SMART on FHIR R4 endpoints and NLP intent routing logic.

Run this script directly with:
    python nurse_mate_api.py
...
if __name__ == "__main__":
    print("Starting Nurse Mate Smart Assistant API...")
